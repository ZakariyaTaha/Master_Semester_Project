...
path_images={"train":os.path.join(base, 'crop_images'),
             "test":os.path.join(base, 'images'),
             "easy":os.path.join(base, 'crop_images')}
path_labels={"train":os.path.join(base, 'crop_labels'),
             "test":os.path.join(base, 'labels'),
             "easy":os.path.join(base, 'crop_labels')}
path_distlabels={"train":os.path.join(base, 'crop_dist_labels'),
                 "test":os.path.join(base, 'dist_labels'),
                 "easy":os.path.join(base, 'easy_crop_dist_labels')}
graph_labels={"train":os.path.join(base, 'crop_graphs'),
              "test":os.path.join(graph_base, 'graphs'),
              "easy":os.path.join(base, 'easy_crop_graphs')}
path_labels_thin={"orig":os.path.join(base, 'labels')}

tr = ['6.t7.npy','14.t7.npy',
      '17.t7.npy','3.t7.npy',
      '5.t7.npy','0.t7.npy',
      '12.t7.npy','13.t7.npy',
      '1.t7.npy','8.t7.npy']
...
for t in tr:
    for j in range(48):
        tr2.append(t[:-4] + "_" + str(j) + ".npy")
    
    sequences = {"training": tr2,
                 "trial":tr2[:20],
